		...
		function emailAuth(){
			$.ajax({
				...
				success  : function(result){
					...
					//Swal.fire("발송완료!", "결과 : " + result, "success");
						Toast.fire("발송완료!", "인증번호가 발송되었습니다.", "success");
					} else {
						
						//Swal.fire("발송되지 않았습니다!", "문제 발생!", "info");	
						Toast.fire("문제발생!", "발송되지않음.", "info");
					}
				},
				error 	 : function(request, status, error){
					Swal.fire("에러!", "무언가 문제가 발생했습니다. : " + error, "warning");
				}
			});
		}
		</script>
